...
def add_arguments_preprocess(parser: ap.ArgumentParser):
    ...
    parser.add_argument(
        "--config-file", default=None, help="Config file to update (default: src/PT-RAG/configs/state-defaults.yaml)"
    )
    parser.add_argument(
        "--all-embeddings",
        default=None,
...
def run_emb_preprocess(args):
    ...
    if args.config_file is None:
        args.config_file = "src/PT-RAG/configs/state-defaults.yaml"
